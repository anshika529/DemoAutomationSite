...
public class RegistrationPage extends BaseTest {
	...
	public void registrationactions() {
		...
		ElementHelpers.selectfromdropdown(driver, Loc_path.getProperty("Countries"),
				Data_path.getProperty("CountryValue"));

		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);

		ElementHelpers.selectfromdropdown(driver, Loc_path.getProperty("Countries"),
				Data_path.getProperty("SelectedValue"));

		// ElementHelpers.clickElement(driver, Loc_path.getProperty("Countries"));
		// ElementHelpers.sendkeys(driver, Loc_path.getProperty("SelectCountry"),
		// Data_path.getProperty("SelectedValue") );

		ElementHelpers.selectfromdropdown(driver, Loc_path.getProperty("Year"), Data_path.getProperty("SelectedYear"));
		ElementHelpers.selectfromdropdown(driver, Loc_path.getProperty("Month"),
				Data_path.getProperty("SelectedMonth"));
